...
?>
            ...
            <li>
                <form method="get" action="<?php echo Yii::app()->request->baseUrl; ?>/search.php">
                    <div>
                        <input type="text" value="' .L('LABEL_SEARCH_TIPS') .'" name="keyword" id="keyword" class="searchbox" onfocus="this.value=''"/>
                        <input type="image" src="<?php echo Yii::app()->request->baseUrl; ?>/images/bt_go.gif" class="searchbutton"/>
                    </div>
                </form>
            </li>
            <li><a href="<?php echo Yii::app()->request->baseUrl; ?>/help" class="white" target="_blank">' .L('MENU_HELP') .'</a></li>
...
<?php echo $this->renderPartial('//layouts/partial/head'); ?>
...
<?php echo $this->renderPartial('//layouts/partial/footer'); ?>
